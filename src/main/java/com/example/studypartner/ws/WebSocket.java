package com.example.studypartner.ws;


import cn.hutool.core.date.DateUtil;
import cn.hutool.json.JSONObject;
import cn.hutool.json.JSONUtil;
import com.example.studypartner.config.HttpSessionConfig;
...
import com.example.studypartner.domain.request.MessageRequest;
...
public class WebSocket {
	 ...
	 * 保存队伍的连接信息
	 */
	private static final ConcurrentHashMap<String, ConcurrentHashMap<String, WebSocket>> ROOMS = new ConcurrentHashMap<>();
...
//			sendMessage();
	...
	private void teamChat(User user, String text, Team team, Integer chatType) {
		...
		WebSocketVO fromUserWebSocketVO = new WebSocketVO();
		BeanUtils.copyProperties(user, fromUserWebSocketVO);
		chatMessageVO.setFromUser(fromUserWebSocketVO);
...
//        }
		...
		chat.setContent(String.valueOf(text));
